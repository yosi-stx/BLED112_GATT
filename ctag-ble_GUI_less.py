...
file1 = open("C:\Work\Python\BLED112_GATT\log\encoder_log.csv","w") 
# file1 = open("C:\Work\Python\CTAG_HID\src\log\encoder_log.csv","w") 
...
def main():
    ...
    try:
        ...
        # Run the GUI main loop // wait forever
        input()
    finally:
        if device != None:
            device.disconnect()
